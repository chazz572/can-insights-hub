        ...
        <CardContent>
          <div className="relative h-64 overflow-hidden rounded-lg border border-glass-border bg-glass p-5">
            ...
            <div className="grid h-full gap-3">
              {timeline.map((id, index) => <div key={id} className="flex items-center gap-3"><span className="w-24 font-mono text-xs text-muted-foreground">{id}</span><span className="h-2 rounded-full bg-gradient-accent shadow-glow" style={{ width: `${28 + index * 7}%` }} /></div>)}
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="animate-fade-up overflow-hidden">
        ...
        <CardContent>
          <div className="rounded-lg border border-glass-border bg-glass p-5">
            <div className="h-2 rounded-full bg-secondary"><div className="h-full w-2/3 rounded-full bg-gradient-accent" /></div>
            <div className="mt-5 grid grid-cols-3 gap-3 text-center text-sm"><div className="rounded-lg bg-secondary p-3">00:00</div><div className="rounded-lg bg-secondary p-3 text-primary">Live</div><div className="rounded-lg bg-secondary p-3">02:41</div></div>
          </div>

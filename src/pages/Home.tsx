    ...
    <section className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl flex-col justify-center gap-10 py-10">
      <div className="grid items-center gap-10 xl:grid-cols-[1.05fr_0.95fr]">
        <div className="animate-fade-up">
          ...
          <h1 className="max-w-4xl text-5xl font-extrabold leading-tight text-foreground sm:text-6xl lg:text-7xl">CJL CAN Intelligence Platform</h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">
            Upload CSV, TRC, candump, ASC, BLF, MF4, CRTD, DBC, J1939, or TXT logs and turn raw CAN traffic into structured anomaly reports, signal candidates, and vehicle behavior insights.
          </p>
